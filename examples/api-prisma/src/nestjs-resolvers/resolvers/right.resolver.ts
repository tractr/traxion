...
export class RightResolver {
    constructor(private readonly rightService: RightService, private readonly roleService: RoleService) {
    }
    ...
    async createRight(@Info() info: GraphQLResolveInfo, @Args() { data }: CreateOneRightArgs) {
