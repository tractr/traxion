...
export class RoleResolver {
    constructor(private readonly roleService: RoleService, private readonly userService: UserService, private readonly rightService: RightService) {
    }
    ...
    async createRole(@Info() info: GraphQLResolveInfo, @Args() { data }: CreateOneRoleArgs) {
