...
import { UserService, RoleService, ProfileService } from "../../nestjs-services";
...
export class UserResolver {
    constructor(private readonly userService: UserService, private readonly roleService: RoleService, private readonly profileService: ProfileService) {
    }
    ...
    async createUser(@Info() info: GraphQLResolveInfo, @Args() { data }: CreateOneUserArgs) {
