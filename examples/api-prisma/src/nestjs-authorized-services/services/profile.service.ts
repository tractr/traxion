...
export class ProfileAuthorizedService {
    constructor(@Inject(PROFILE_SERVICE) private readonly profileService: ProfileService, private readonly prisma: PrismaService) {
    }

    async findUnique<T extends Prisma.ProfileFindUniqueArgs>(args: Prisma.SelectSubset<T, Prisma.ProfileFindUniqueArgs>, abilities: AnyAbility, prisma?: Prisma.ProfileDelegate<undefined>) {
    ...
    async findMany<T extends Prisma.ProfileFindManyArgs>(args: Prisma.SelectSubset<T, Prisma.ProfileFindManyArgs>, abilities: AnyAbility, prisma?: Prisma.ProfileDelegate<undefined>) {
        const where = {
                AND: [abilities ? accessibleBy(abilities).Profile : {}, args?.where ?? {}],
              };
        return this.profileService.findMany<T>({ ...args, where }, prisma);
    }

    async create<T extends Prisma.ProfileCreateArgs>(args: Prisma.SelectSubset<T, Prisma.ProfileCreateArgs>, abilities: AnyAbility, prisma?: Prisma.ProfileDelegate<undefined>) {
    ...
    async update<T extends Prisma.ProfileUpdateArgs>(args: Prisma.SelectSubset<T, Prisma.ProfileUpdateArgs>, abilities: AnyAbility, prisma?: Prisma.ProfileDelegate<undefined>) {
    ...
    async delete<T extends Prisma.ProfileDeleteArgs>(args: Prisma.SelectSubset<T, Prisma.ProfileDeleteArgs>, abilities: AnyAbility, prisma?: Prisma.ProfileDelegate<undefined>) {
    ...
    async count<T extends Prisma.ProfileCountArgs>(args: Prisma.SelectSubset<T, Prisma.ProfileCountArgs>, abilities: AnyAbility, prisma?: Prisma.ProfileDelegate<undefined>) {
        const where = {
                AND: [abilities ? accessibleBy(abilities).Profile : {}, args?.where ?? {}],
              };
