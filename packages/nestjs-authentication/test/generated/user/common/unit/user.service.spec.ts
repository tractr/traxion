...
describe('UserService', () => {
  ...
  beforeEach(async () => {
    mockedUserDatabaseService = (mockUserDatabaseServiceFactory() as unknown) as UserDatabaseService;
  ...
  describe('findUnique', () => {
    it('should map to UserDatabaseService.findUnique', async () => {
      ...
      const user = mockUserFactory();
      (mockedUserDatabaseService.findUnique as jest.Mock).mockReturnValueOnce(user);
  ...
  describe('findMany', () => {
    it('should map to UserDatabaseService.findMany', async () => {
      ...
      (mockedUserDatabaseService.findMany as jest.Mock).mockReturnValueOnce(user);
