...
import { AsyncOptions, ModuleOverrideMetadata } from '@tractr/nestjs-core';
...
declare const AuthenticationModule_base: {
    ...
    registerAsync(options: AsyncOptions<AuthenticationOptions, import("@tractr/nestjs-core").OptionsFactory<AuthenticationOptions>>): DynamicModule;
    createAsyncProviders(options: AsyncOptions<AuthenticationOptions, import("@tractr/nestjs-core").OptionsFactory<AuthenticationOptions>>): import("@nestjs/common").Provider<any>[];
    createAsyncOptionsProvider(options: AsyncOptions<AuthenticationOptions, import("@tractr/nestjs-core").OptionsFactory<AuthenticationOptions>>): import("@nestjs/common").Provider<any>;
};
