...
>(type: T, name: string, constraints: C, options: O = {} as O) {
  return {
    ...
    ...constraints,
    ...options,
  } as unknown as GetField<F, T> & C & O;
}
...
export type DefaultValueSettable<
  F extends BaseField<string, Constraints<KeyType, any>>,
...
export type StringFormatConstraint = OptionalConstraint<
  'format',
...
export type NumberFormatConstraint = OptionalConstraint<
  'format',
  'integer' | 'float'
>;
 ...
 * Enum constraints
 */
export type EnumConstraints = BaseConstraints & EnumConstraint;

export type EnumConstraint = Constraints<'enum', string[]>;
 ...
 */
export type PrimaryKeyType = RequiredConstraint<
  'fieldType',
  'string' | 'number'
>;
export type PrimaryKeyAuto = OptionalConstraint<'auto', 'increment' | 'uuid'>;

/**
 * Foreign Key constraints
 */
export type PrimaryKeyConstraints = BaseConstraints &
  RelationsConstraint &
  PrimaryKeyAuto &
  PrimaryKeyType;
 ...
 * Virtual constraints
 */
export type ForeignKeyConstraints = BaseConstraints &
  RelationConstraint &
  RequiredConstraint<'isUnique', true>;
...
export type PrimaryKeyField = BaseField<'primary', PrimaryKeyConstraints>;
export type VirtualField = BaseField<'virtual', VirtualConstraints>;
export type ForeignKeyField = BaseField<'foreign', ForeignKeyConstraints>;
