...
export function and<S, T1 extends S>(
  predicate1: Predicate<S, T1>,
): Predicate<S, T1>;
export function and<S, T1 extends S, T2 extends S>(
  predicate1: Predicate<S, T1>,
  predicate2: Predicate<S, T2>,
): Predicate<S, T1 & T2>;
export function and<S, T1 extends S, T2 extends S, T3 extends S>(
  predicate1: Predicate<S, T1>,
  predicate2: Predicate<S, T2>,
  predicate3: Predicate<S, T3>,
): Predicate<S, T1 & T2 & T3>;
export function and<S, T1 extends S, T2 extends S, T3 extends S, T4 extends S>(
  predicate1: Predicate<S, T1>,
  predicate2: Predicate<S, T2>,
  predicate3: Predicate<S, T3>,
...
>(
  ...
  return (
    value: S,
  ): value is T1 & T2 & T3 & T4 & T5 & T6 & T7 & T8 & T9 & T10 =>
    predicate1(value) &&
